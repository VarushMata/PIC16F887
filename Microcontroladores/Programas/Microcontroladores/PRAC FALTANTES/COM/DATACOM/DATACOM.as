...
z	equ	0
pclath	equ	10
# 7 "C:\Users\Jorge\OneDrive\Escritorio\Entregar\COM\DATACOM\DATACOM.c"
	psect config,class=CONFIG,delta=2 ;#
# 7 "C:\Users\Jorge\OneDrive\Escritorio\Entregar\COM\DATACOM\DATACOM.c"
	dw 0xFFFC & 0xFFF7 & 0xFFFF & 0xFFFF& 0xFFFF & 0xFFFF & 0xFCFF & 0xFBFF & 0xF7FF & 0xEFFF & 0xFFFF ;#
# 8 "C:\Users\Jorge\OneDrive\Escritorio\Entregar\COM\DATACOM\DATACOM.c"
	psect config,class=CONFIG,delta=2 ;#
# 8 "C:\Users\Jorge\OneDrive\Escritorio\Entregar\COM\DATACOM\DATACOM.c"
	dw 0xFFFF & 0xFFFF ;#
...
putch@byte:	; 1 bytes @ 0x0
	global	_isdigit$2435
_isdigit$2435:	; 1 bytes @ 0x0
...
main@i:	; 2 bytes @ 0x11
	ds	2
	global	main@i_1854
main@i_1854:	; 2 bytes @ 0x13
	ds	2
	global	main@i_1856
main@i_1856:	; 2 bytes @ 0x15
	ds	2
;;Data sizes: Strings 70, constant 10, data 0, bss 40, persistent 0 stack 0
...
;;		 -> STR_12(CODE[3]), STR_10(CODE[3]), STR_4(CODE[3]), 
;;
...
;;		 -> STR_9(CODE[4]), STR_8(CODE[4]), STR_7(CODE[15]), STR_6(CODE[15]), 
;;		 -> STR_3(CODE[4]), STR_2(CODE[4]), STR_1(CODE[14]), 
;;
...
;;
;; _doprnt@f	PTR const unsigned char  size(1) Largest target is 15
;;		 -> STR_12(CODE[3]), STR_10(CODE[3]), STR_9(CODE[4]), STR_8(CODE[4]), 
;;		 -> STR_7(CODE[15]), STR_6(CODE[15]), STR_4(CODE[3]), STR_3(CODE[4]), 
;;		 -> STR_2(CODE[4]), STR_1(CODE[14]), 
;;
;; S1882__prbuf$func	PTR FTN(unsigned char ,)void  size(1) Largest target is 0
;;		 -> Absolute function(), putch(), 
;;
;; _doprnt@pb.func	PTR FTN(unsigned char ,)void  size(1) Largest target is 0
;;		 -> Absolute function(), putch(), 
;;
;; S1882__prbuf$ptr	PTR unsigned char  size(1) Largest target is 5
;;		 -> NULL(NULL[0]), carac3(BANK0[5]), carac2(BANK0[5]), carac1(BANK0[4]), 
;;
...
;;		 -> STR_13(CODE[6]), carac3(BANK0[5]), STR_11(CODE[6]), carac2(BANK0[5]), 
...
;; *************** function _main *****************
;; Defined at:
;;		line 82 in file "C:\Users\Jorge\OneDrive\Escritorio\Entregar\COM\DATACOM\DATACOM.c"
...
;;
psect	maintext
	file	"C:\Users\Jorge\OneDrive\Escritorio\Entregar\COM\DATACOM\DATACOM.c"
	line	82
...
l3482:	
;DATACOM.c: 118: printf("Valores ADC:\N");
	movlw	((STR_1-__stringbase))&0ffh
	fcall	_printf
	line	120
	
l3484:	
;DATACOM.c: 120: printf("%d ",vadc1);
	movf	(_vadc1+1),w
	movwf	(?_printf+1)
	movf	(_vadc1),w
	movwf	(?_printf)
...
l3488:	
;DATACOM.c: 127: for(int i=0;i<=2;i++){
	clrf	(main@i)
	clrf	(main@i+1)
	line	128
	
l3494:	
;DATACOM.c: 128: PA[i]=getch();}
	bcf	status, 5	;RP0=0, select bank0
...
l3502:	
;DATACOM.c: 131: PORTA=0x00;
	clrf	(5)	;volatile
	line	132
	
l3504:	
;DATACOM.c: 132: PORTA = vporta;
	movf	(_vporta),w
	movwf	(5)	;volatile
	line	134
	
l3506:	
;DATACOM.c: 134: lcd_clear();
	fcall	_lcd_clear
	line	136
	
l3508:	
;DATACOM.c: 136: sprintf(carac1, "%d",vporta);
...
l3510:	
;DATACOM.c: 137: lcd_goto(0x00);
	movlw	(0)
	fcall	_lcd_goto
	line	138
	
l3512:	
;DATACOM.c: 138: lcd_puts("porta:");
...
l3516:	
;DATACOM.c: 147: printf("Escriba PWM1:\n");
...
l3532:	
;DATACOM.c: 153: printf("Escriba PWM2:\n");
	movlw	((STR_7-__stringbase))&0ffh
	fcall	_printf
	line	155
	
l3534:	
;DATACOM.c: 155: for(int i=0;i<=3;i++){
	clrf	(main@i_1856)
	clrf	(main@i_1856+1)
	line	156
	
l3540:	
;DATACOM.c: 156: PA2[i]=getch();}
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(main@i_1856),w
	addlw	_PA2&0ffh
...
l3542:	
	incf	(main@i_1856),f
	skipnz
	incf	(main@i_1856+1),f
	
l3544:	
	movf	(main@i_1856+1),w
	xorlw	80h
	movwf	btemp+1
	movlw	(high(04h))^80h
	subwf	btemp+1,w
...
l3548:	
;DATACOM.c: 159: lcd_clear();
	fcall	_lcd_clear
	line	161
	
l3550:	
;DATACOM.c: 161: printf("%d ",pwm1);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_pwm1+1),w
	movwf	(?_printf+1)
...
l3554:	
;DATACOM.c: 164: sprintf(carac2, "%d",pwm1);
...
l3556:	
;DATACOM.c: 165: lcd_goto(0x00);
	movlw	(0)
	fcall	_lcd_goto
	line	166
	
l3558:	
;DATACOM.c: 166: lcd_puts("pwm1:");
...
l3562:	
;DATACOM.c: 169: sprintf(carac3, "%d",pwm2);
...
l3564:	
;DATACOM.c: 170: lcd_goto(0x40);
	movlw	(040h)
	fcall	_lcd_goto
	line	171
	
l3566:	
;DATACOM.c: 171: lcd_puts("pwm2:");
...
;; *************** function _lcd_init *****************
;; Defined at:
;;		line 242 in file "C:\Users\Jorge\OneDrive\Escritorio\Entregar\COM\DATACOM\DATACOM.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
...
l3422:	
;DATACOM.c: 252: PORTD = init_value;
	movlw	(03h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(8)	;volatile
...
l3424:	
;DATACOM.c: 253: ((RC0 = 1),(RC0=0));
	bsf	(56/8),(56)&7
	
l3426:	
	bcf	(56/8),(56)&7
	line	254
;DATACOM.c: 254: pause(10);
	movlw	0Ah
	movwf	(?_pause)
	clrf	(?_pause+1)
	fcall	_pause
...
l3442:	
;DATACOM.c: 262: lcd_write(0x28);
	movlw	(028h)
	fcall	_lcd_write
	line	263
	
l3444:	
;DATACOM.c: 263: lcd_write(0x0C);
	movlw	(0Ch)
	fcall	_lcd_write
	line	264
	
l3446:	
;DATACOM.c: 264: lcd_write(0x0F);
	movlw	(0Fh)
	fcall	_lcd_write
	line	265
	
l3448:	
;DATACOM.c: 265: lcd_clear();
	fcall	_lcd_clear
	line	266
	
l3450:	
;DATACOM.c: 266: lcd_write(0x06);
	movlw	(06h)
	fcall	_lcd_write
	line	267
...
;; *************** function _lcd_puts *****************
;; Defined at:
;;		line 226 in file "C:\Users\Jorge\OneDrive\Escritorio\Entregar\COM\DATACOM\DATACOM.c"
;; Parameters:    Size  Location     Type
;;  s               2    5[COMMON] PTR const unsigned char 
;;		 -> STR_13(6), carac3(5), STR_11(6), carac2(5), 
;;		 -> STR_5(7), carac1(4), 
;; Auto vars:     Size  Location     Type
;;		None
;; Return value:  Size  Location     Type
...
;DATACOM.c: 227: RC3 = 1;
	bsf	(59/8),(59)&7
	line	228
;DATACOM.c: 228: while(*s)
	goto	l3410
	line	229
	
l3406:	
;DATACOM.c: 229: lcd_write(*s++);
	movf	(lcd_puts@s+1),w
	movwf	btemp+1
	movf	(lcd_puts@s),w
	movwf	fsr0
...
;; *************** function _lcd_goto *****************
;; Defined at:
;;		line 237 in file "C:\Users\Jorge\OneDrive\Escritorio\Entregar\COM\DATACOM\DATACOM.c"
;; Parameters:    Size  Location     Type
...
l3402:	
;DATACOM.c: 239: lcd_write(0x80 + pos);
	movf	(lcd_goto@pos),w
	addlw	080h
	fcall	_lcd_write
	line	240
...
;; *************** function _lcd_clear *****************
;; Defined at:
;;		line 220 in file "C:\Users\Jorge\OneDrive\Escritorio\Entregar\COM\DATACOM\DATACOM.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l3398:	
;DATACOM.c: 222: lcd_write(0x01);
	movlw	(01h)
	fcall	_lcd_write
	line	223
;DATACOM.c: 223: pause (2);
	movlw	02h
	movwf	(?_pause)
	clrf	(?_pause+1)
	fcall	_pause
...
;; *************** function _lcd_write *****************
;; Defined at:
;;		line 212 in file "C:\Users\Jorge\OneDrive\Escritorio\Entregar\COM\DATACOM\DATACOM.c"
;; Parameters:    Size  Location     Type
...
;; *************** function _PWM *****************
;; Defined at:
;;		line 196 in file "C:\Users\Jorge\OneDrive\Escritorio\Entregar\COM\DATACOM\DATACOM.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l3366:	
;DATACOM.c: 198: ADRESL=pwm1<<8;
	bsf	status, 5	;RP0=1, select bank1
	clrf	(158)^080h	;volatile
	line	199
	
l3368:	
;DATACOM.c: 199: CCPR1L=ADRESH;
	bcf	status, 5	;RP0=0, select bank0
	movf	(30),w	;volatile
	movwf	(21)	;volatile
	line	200
...
l3370:	
;DATACOM.c: 200: CCP1CON=0X0C|(ADRESL>>2);
	bsf	status, 5	;RP0=1, select bank1
...
l3376:	
;DATACOM.c: 204: ADRESL=pwm2<<8;
	bsf	status, 5	;RP0=1, select bank1
	clrf	(158)^080h	;volatile
	line	205
	
l3378:	
;DATACOM.c: 205: CCPR2L=ADRESH;
	bcf	status, 5	;RP0=0, select bank0
	movf	(30),w	;volatile
	movwf	(27)	;volatile
	line	206
...
l3380:	
;DATACOM.c: 206: CCP2CON=0X0C|(ADRESL>>2);
	bsf	status, 5	;RP0=1, select bank1
	movf	(158)^080h,w	;volatile
	movwf	(??_PWM+0)+0
	clrc
...
;;		 -> STR_9(4), STR_8(4), STR_7(15), STR_6(15), 
;;		 -> STR_3(4), STR_2(4), STR_1(14), 
;; Auto vars:     Size  Location     Type
...
;;		 -> STR_12(3), STR_10(3), STR_9(4), STR_8(4), 
;;		 -> STR_7(15), STR_6(15), STR_4(3), STR_3(4), 
;;		 -> STR_2(4), STR_1(14), 
...
;; *************** function _pause *****************
;; Defined at:
;;		line 269 in file "C:\Users\Jorge\OneDrive\Escritorio\Entregar\COM\DATACOM\DATACOM.c"
;; Parameters:    Size  Location     Type
...
l3266:	
;DATACOM.c: 270: unsigned short x;
;DATACOM.c: 271: for (x=0; x<=usvalue; x++)
	clrf	(pause@x)
	clrf	(pause@x+1)
	goto	l3272
	line	273
...
;; *************** function _msecbase *****************
;; Defined at:
;;		line 277 in file "C:\Users\Jorge\OneDrive\Escritorio\Entregar\COM\DATACOM\DATACOM.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l3156:	
;DATACOM.c: 278: OPTION_REG = 0b11010001;
	movlw	(0D1h)
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	movwf	(129)^080h	;volatile
	line	279
;DATACOM.c: 279: TMR0 = 0x0E;
	movlw	(0Eh)
	bcf	status, 5	;RP0=0, select bank0
	movwf	(1)	;volatile
	line	280
;DATACOM.c: 280: TMR0 = 0x8E;
	movlw	(08Eh)
	movwf	(1)	;volatile
	line	281
;DATACOM.c: 281: while(!T0IF);
...
;; *************** function _ADC *****************
;; Defined at:
;;		line 183 in file "C:\Users\Jorge\OneDrive\Escritorio\Entregar\COM\DATACOM\DATACOM.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l3140:	
;DATACOM.c: 184: ADCON0=0xD5;
	movlw	(0D5h)
	movwf	(31)	;volatile
	line	185
	
l3142:	
;DATACOM.c: 185: GO_DONE=1;
	bsf	(249/8),(249)&7
	line	186
;DATACOM.c: 186: while(GO_DONE);
...
l3144:	
;DATACOM.c: 187: vadc1=(ADRESH<<2)|(ADRESL>>6);
	movf	(30),w	;volatile
	movwf	(_vadc1)
	clrf	(_vadc1+1)
...
l3148:	
;DATACOM.c: 189: ADCON0=0xD9;
	movlw	(0D9h)
	movwf	(31)	;volatile
	line	190
	
l3150:	
;DATACOM.c: 190: GO_DONE=1;
	bsf	(249/8),(249)&7
	line	191
;DATACOM.c: 191: while(GO_DONE);
...
l3152:	
;DATACOM.c: 192: vadc2=(ADRESH<<2)|(ADRESL>>6);
	movf	(30),w	;volatile
	movwf	(_vadc2)
	clrf	(_vadc2+1)
...
;; Defined at:
;;		line 50 in file "C:\Users\Jorge\OneDrive\Escritorio\Entregar\COM\DATACOM\DATACOM.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _getch *****************
;; Defined at:
;;		line 43 in file "C:\Users\Jorge\OneDrive\Escritorio\Entregar\COM\DATACOM\DATACOM.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _putch *****************
;; Defined at:
;;		line 36 in file "C:\Users\Jorge\OneDrive\Escritorio\Entregar\COM\DATACOM\DATACOM.c"
;; Parameters:    Size  Location     Type
