...
z	equ	0
pclath	equ	10
# 8 "C:\Users\Jorge\OneDrive\Escritorio\Entregar\DIST\SRPROG2\SRPROG2.c"
	psect config,class=CONFIG,delta=2 ;#
# 8 "C:\Users\Jorge\OneDrive\Escritorio\Entregar\DIST\SRPROG2\SRPROG2.c"
	dw 0xFFFC & 0xFFF7 & 0xFFFF & 0xFFFF& 0xFFFF & 0xFFFF & 0xFCFF & 0xFBFF & 0xF7FF & 0xEFFF & 0xFFFF ;#
# 9 "C:\Users\Jorge\OneDrive\Escritorio\Entregar\DIST\SRPROG2\SRPROG2.c"
	psect config,class=CONFIG,delta=2 ;#
# 9 "C:\Users\Jorge\OneDrive\Escritorio\Entregar\DIST\SRPROG2\SRPROG2.c"
	dw 0xFFFF & 0xFFFF ;#
...
;; *************** function _main *****************
;; Defined at:
;;		line 66 in file "C:\Users\Jorge\OneDrive\Escritorio\Entregar\DIST\SRPROG2\SRPROG2.c"
...
;;
psect	maintext
	file	"C:\Users\Jorge\OneDrive\Escritorio\Entregar\DIST\SRPROG2\SRPROG2.c"
	line	66
...
l3350:	
;SRPROG2.c: 140: if(dist<3 || 350<dist){
	movlw	high(03h)
	subwf	(_dist+1),w
	movlw	low(03h)
	skipnz
...
l3354:	
;SRPROG2.c: 141: lcd_goto(0x00);
	movlw	(0)
	fcall	_lcd_goto
	line	142
	
l3356:	
;SRPROG2.c: 142: lcd_puts("SIN RANGO");
	...
	fcall	_lcd_puts
	line	143
;SRPROG2.c: 143: }else if(3<dist || dist<350){
	goto	l3378
...
l3362:	
;SRPROG2.c: 144: sprintf(carac1, "%d",dist);
...
l3364:	
;SRPROG2.c: 146: dato = atoi(carac1);
	movlw	(_carac1)&0ffh
	fcall	_atoi
	movf	(1+(?_atoi)),w
	movwf	(_dato+1)
...
l3368:	
;SRPROG2.c: 149: lcd_goto(0x00);
	movlw	(0)
	fcall	_lcd_goto
	line	150
	
l3370:	
;SRPROG2.c: 150: lcd_puts("Dist:");
...
l3374:	
;SRPROG2.c: 152: lcd_goto(0x0A);
	movlw	(0Ah)
	fcall	_lcd_goto
	line	153
	
l3376:	
;SRPROG2.c: 153: lcd_puts("cm");
...
l3378:	
;SRPROG2.c: 154: }
;SRPROG2.c: 156: _delay((unsigned long)((200)*(4000000/4000.0)));
	opt asmopt_off
movlw  2
movwf	((??_main+0)+0+2),f
movlw	4
...
;; *************** function _lcd_init *****************
;; Defined at:
;;		line 193 in file "C:\Users\Jorge\OneDrive\Escritorio\Entregar\DIST\SRPROG2\SRPROG2.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
...
l3262:	
;SRPROG2.c: 203: PORTD = init_value;
	movlw	(03h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(8)	;volatile
...
l3264:	
;SRPROG2.c: 204: ((RC0 = 1),(RC0=0));
	bsf	(56/8),(56)&7
	
l3266:	
	bcf	(56/8),(56)&7
	line	205
;SRPROG2.c: 205: pause(10);
	movlw	0Ah
	movwf	(?_pause)
	clrf	(?_pause+1)
	fcall	_pause
...
l3282:	
;SRPROG2.c: 213: lcd_write(0x28);
	movlw	(028h)
	fcall	_lcd_write
	line	214
	
l3284:	
;SRPROG2.c: 214: lcd_write(0x0C);
	movlw	(0Ch)
	fcall	_lcd_write
	line	215
	
l3286:	
;SRPROG2.c: 215: lcd_write(0x0F);
	movlw	(0Fh)
	fcall	_lcd_write
	line	216
	
l3288:	
;SRPROG2.c: 216: lcd_clear();
	fcall	_lcd_clear
	line	217
	
l3290:	
;SRPROG2.c: 217: lcd_write(0x06);
	movlw	(06h)
	fcall	_lcd_write
	line	218
...
;; *************** function _lcd_clear *****************
;; Defined at:
;;		line 171 in file "C:\Users\Jorge\OneDrive\Escritorio\Entregar\DIST\SRPROG2\SRPROG2.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l3250:	
;SRPROG2.c: 173: lcd_write(0x01);
	movlw	(01h)
	fcall	_lcd_write
	line	174
;SRPROG2.c: 174: pause (2);
	movlw	02h
	movwf	(?_pause)
	clrf	(?_pause+1)
	fcall	_pause
...
;; *************** function _lcd_puts *****************
;; Defined at:
;;		line 177 in file "C:\Users\Jorge\OneDrive\Escritorio\Entregar\DIST\SRPROG2\SRPROG2.c"
;; Parameters:    Size  Location     Type
...
;SRPROG2.c: 178: RC3 = 1;
	bsf	(59/8),(59)&7
	line	179
;SRPROG2.c: 179: while(*s)
	goto	l3246
	line	180
	
l3242:	
;SRPROG2.c: 180: lcd_write(*s++);
	movf	(lcd_puts@s+1),w
	movwf	btemp+1
	movf	(lcd_puts@s),w
	movwf	fsr0
...
;; *************** function _lcd_goto *****************
;; Defined at:
;;		line 188 in file "C:\Users\Jorge\OneDrive\Escritorio\Entregar\DIST\SRPROG2\SRPROG2.c"
;; Parameters:    Size  Location     Type
...
l3238:	
;SRPROG2.c: 190: lcd_write(0x80 + pos);
	movf	(lcd_goto@pos),w
	addlw	080h
	fcall	_lcd_write
	line	191
...
;; *************** function _lcd_write *****************
;; Defined at:
;;		line 163 in file "C:\Users\Jorge\OneDrive\Escritorio\Entregar\DIST\SRPROG2\SRPROG2.c"
;; Parameters:    Size  Location     Type
...
;; *************** function _pause *****************
;; Defined at:
;;		line 220 in file "C:\Users\Jorge\OneDrive\Escritorio\Entregar\DIST\SRPROG2\SRPROG2.c"
;; Parameters:    Size  Location     Type
...
l3124:	
;SRPROG2.c: 221: unsigned short x;
;SRPROG2.c: 222: for (x=0; x<=usvalue; x++)
	clrf	(pause@x)
	clrf	(pause@x+1)
	goto	l3130
	line	224
...
;; *************** function _msecbase *****************
;; Defined at:
;;		line 228 in file "C:\Users\Jorge\OneDrive\Escritorio\Entregar\DIST\SRPROG2\SRPROG2.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
l3014:	
;SRPROG2.c: 229: OPTION_REG = 0b11010010;
	movlw	(0D2h)
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	movwf	(129)^080h	;volatile
	line	230
;SRPROG2.c: 230: TMR0 = 0x0E;
	movlw	(0Eh)
	bcf	status, 5	;RP0=0, select bank0
	movwf	(1)	;volatile
	line	231
;SRPROG2.c: 231: TMR0 = 0x8E;
	movlw	(08Eh)
	movwf	(1)	;volatile
	line	232
;SRPROG2.c: 232: while(!T0IF);
...
;; Defined at:
;;		line 52 in file "C:\Users\Jorge\OneDrive\Escritorio\Entregar\DIST\SRPROG2\SRPROG2.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _getch *****************
;; Defined at:
;;		line 45 in file "C:\Users\Jorge\OneDrive\Escritorio\Entregar\DIST\SRPROG2\SRPROG2.c"
;; Parameters:    Size  Location     Type
;;		None
;; Auto vars:     Size  Location     Type
;;		None
...
;; *************** function _putch *****************
;; Defined at:
;;		line 38 in file "C:\Users\Jorge\OneDrive\Escritorio\Entregar\DIST\SRPROG2\SRPROG2.c"
;; Parameters:    Size  Location     Type
